...
void fun_print(int n, student* mas);
int fun_delete_matchng(int n, string p_num, double mid_gr, student* mas);
void fun_add(int n, string name, student* mas);
...
int main()
{
    ...
    n = fun_delete_matchng(n, (string)p_num, mid_gr, mas);
    fun_print(n, mas);
